	...
	//	$PointSuspension		= '';	 // (décommentez si vous ne voulez pas de points de suspension)
		...
		if( $NombreBouts == 1 )
		{
			...
			if ($PointSuspension!='' && $LongueurAvantSansHtml > $nbreCar) {
				// si les points de suspension sont après une(des) balise(s) fermante, on les "remonte" jusqu'à l'intérieur de la balise non-vide la plus proche
				// on remonrte ici jusqu'à 5 niveaux de balises.
