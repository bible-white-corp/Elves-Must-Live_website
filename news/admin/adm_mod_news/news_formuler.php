...
// ---------------------------------------------------
// Editeur WYSIWYG utilisé : AUCUN (texte brut)
// -----------------
	$traiter 			= '';
...
<?php if (in_array($traiter, array('Ajouter', 'Modifier'))) { ?>
	...
	<script type="text/javascript" src="./js/news_validFormulaire.js"></script>
<?php } ?>
...
<?php 		} ?>
		...
		<p><!-- Contenu -->
			<label for="idnewsContenu">Contenu <abbr title="obligatoire">*</abbr>:</label>
			<textarea id="idnewsContenu" name="newsContenu" rows="20" cols="70"><?php echo htmlentities($newsContenu); ?></textarea>
		</p>
	</div>
